...
<a>
        <img src="img/run.png" alt="run the project" width="600" height="600"/>
  </a>

The following window appears. We click “Yes,” and another warning window shows up, to which we also click “Yes.”

<a>
        <img src="img/certificado.png" alt="certificate" width="600" height="600"/>
  </a>

We go to the project and right-click on “Manage NuGet Packages.”

<a>
        <img src="img/paquetes.png" alt="Packages" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/automapper.png" alt="AutoMapper" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/entities.png" alt="Entities" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/services.png" alt="Context" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/configuracion.png" alt="Configuration" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/repositorio.png" alt="Repository" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/clase.png" alt="Clase" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/inyeccion.png" alt="Injection" width="600" height="600"/>
  </a>
...
<a>
        <img src="img/controladores.png" alt="Controller" width="600" height="600"/>
  </a>

Next, we go to the DTO folder and create the ResponseDto class to standardize all responses.

<a>
        <img src="img/respuesta.png" alt="Responses" width="600" height="600"/>
  </a>

Finally, we repeat the same process for Users, and with that, we complete our API.

<a>
        <img src="img/api.png" alt="API" width="600" height="600"/>
  </a>
