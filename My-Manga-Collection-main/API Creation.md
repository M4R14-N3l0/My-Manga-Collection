...
<a>
        <img src="My-Manga-Collection-main/img/creacion.png" alt="ASP.NET Core Web API project" width="600" height="600"/>
  </a>

We click on IIS Express to run the project.

<a>
        <img src="My-Manga-Collection-main/img/run.png" alt="run the project" width="600" height="600"/>
  </a>

The following window appears. We click “Yes,” and another warning window shows up, to which we also click “Yes.”

<a>
        <img src="My-Manga-Collection-main/img/certificado.png" alt="certificate" width="600" height="600"/>
  </a>

We go to the project and right-click on “Manage NuGet Packages.”

<a>
        <img src="My-Manga-Collection-main/img/paquetes.png" alt="Packages" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/automapper.png" alt="AutoMapper" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/entities.png" alt="Entities" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/services.png" alt="Context" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/connection.png" alt="Connetion" width="600" height="600"/>
  </a>

We go to appsettings.json and enter all the necessary information to establish the database connection.

<a>
        <img src="My-Manga-Collection-main/img/connection2.png" alt="Connetion 2" width="600" height="600"/>
  </a>

We create the folder that will contain the models (the “Anime” and “User” classes).

<a>
        <img src="My-Manga-Collection-main/img/modelos.png" alt="Models" width="600" height="600"/>
  </a>

We go to Tools → NuGet Package Manager → Package Manager Console, and from there we create the tables in our database.

<a>
        <img src="My-Manga-Collection-main/img/Tablas.png" alt="Tables" width="600" height="600"/>
  </a>

In the console, we type: add-migration Tablas Iniciales

<a>
        <img src="My-Manga-Collection-main/img/consola.png" alt="Console" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/dtos.png" alt="DTOs" width="600" height="600"/>
  </a>

In Manga.Services, we create a new class called “MappingConfig” (see code in the appendix) to map the DTOs to the models.

<a>
        <img src="My-Manga-Collection-main/img/mapeo.png" alt="Mapping" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/configuracion.png" alt="Configuration" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/repositorio.png" alt="Repository" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/clase.png" alt="Clase" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/inyeccion.png" alt="Injection" width="600" height="600"/>
  </a>
...
<a>
        <img src="My-Manga-Collection-main/img/controladores.png" alt="Controller" width="600" height="600"/>
  </a>

Next, we go to the DTO folder and create the ResponseDto class to standardize all responses.

<a>
        <img src="My-Manga-Collection-main/img/respuesta.png" alt="Responses" width="600" height="600"/>
  </a>

Finally, we repeat the same process for Users, and with that, we complete our API.

<a>
        <img src="My-Manga-Collection-main/img/api.png" alt="API" width="600" height="600"/>
  </a>
